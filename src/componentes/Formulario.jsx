					...
					<div className="vstack gap-3">
						<div>
							...
							<div className="form-text">
								Nombre tiene que ser 3-20 caracteres de largo.
							</div>
						</div>
						<div>
							<div className="input-group">
							...
							<div className="form-text">
								Formato de Correo: example@dominio.com
							</div>
						</div>
						<div>
							<div className="input-group">
							...
							<div className="form-text">Rango de Edad: 10-99</div>
						</div>
						<div>
							<div className="input-group">
								<span className="input-group-text text-center ">
							...
							<div className="form-text">
								Cargo tiene que ser de 8-30 caracteres.
							</div>
						</div>
						<div>
							<div className="input-group">
							...
							<div className="form-text">
								Formato de Teléphono: x xxxx xxxx
							</div>
						</div>
